...
main_loop:
    ...
    mov esi, num1      ; Puntero a num1
    mov edi, exit_str  ; Puntero a "exit"
    call comparar_exit
    cmp eax, 1
    je salir
...
comparar_exit:
    ; Comparar si la cadena ingresada es "exit"
    mov ecx, 4              ; Comparar 4 caracteres
comparar_loop:
    lodsb                   ; Cargar byte de num1
    scasb                   ; Comparar con byte de exit_str
    jne no_es_exit           ; Si no es igual, salir
    loop comparar_loop       ; Repetir para los 4 caracteres
    mov eax, 1              ; Si son iguales, devolver 1
    ret
no_es_exit:
    mov eax, 0              ; Si no son iguales, devolver 0
    ret
